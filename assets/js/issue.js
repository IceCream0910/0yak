...
function updatePromise(index) {
    ...
    $.get('assets/issue.json', function(data) {console.log(data[index])
        $('#lee-msg').html('<b>'+data[index][0].title+'</b><br>'+data[index][0].msg+'<br><span style="font-size:12px;color:#878787;">'+data[index][0].source+'</span>');
        $('#yun-msg').html('<b>'+data[index][1].title+'</b><br>'+data[index][1].msg+'<br><span style="font-size:12px;color:#878787;">'+data[index][1].source+'</span>');
        $('#sim-msg').html('<b>'+data[index][2].title+'</b><br>'+data[index][2].msg+'<br><span style="font-size:12px;color:#878787;">'+data[index][2].source+'</span>');
        $('#ahn-msg').html('<b>'+data[index][3].title+'</b><br>'+data[index][3].msg+'<br><span style="font-size:12px;color:#878787;">'+data[index][3].source+'</span>');
    });
  }
